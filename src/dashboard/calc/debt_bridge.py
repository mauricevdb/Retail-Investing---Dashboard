...
def _resolve_long_term(facts: pl.DataFrame, cik: str, end: date, t: date) -> tuple[float | None, str | None]:
...
def _resolve_current(facts: pl.DataFrame, cik: str, end: date, t: date) -> tuple[float | None, str | None]:
